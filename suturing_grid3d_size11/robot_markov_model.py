...
class RobotMarkovModel:
    def __init__(self):
        ...
        trajectories1 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/iros2020/suturing_grid3d_size11/grid11_parallel/max_ent_grid11_data1.csv",
             delimiter=",")
        trajectories2 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/iros2020/suturing_grid3d_size11/grid11_parallel/max_ent_grid11_data2.csv",
             delimiter=",")
        trajectories3 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/iros2020/suturing_grid3d_size11/grid11_parallel/max_ent_grid11_data3.csv",
             delimiter=",")
        # trajectories1 = np.genfromtxt\
        #     ("/home/vignesh/Thesis_Suture_data/trial2/suture_data_trial2/730841_edited.csv",
        #      delimiter=",")
        # trajectories2 = np.genfromtxt\
