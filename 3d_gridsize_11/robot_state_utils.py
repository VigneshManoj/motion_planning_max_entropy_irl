...
if __name__ == '__main__':
    ...
    value_arr = np.zeros(len(states))
    for j, ele in V.items():
        value_arr[j] = ele
    filename1 = "/home/vignesh/Desktop/value_grid11.txt"
    file_open1 = open(filename1, 'a')
    savetxt(file_open1, value_arr, delimiter=',', fmt="%10.5f", newline=", ")
    file_open1.write("\n \n \n \n")
    file_open1.close()
