...
class RobotStateUtils(concurrent.futures.ThreadPoolExecutor):
    def __init__(self, grid_size, discount, terminal_state_val_from_trajectory):
        super(RobotStateUtils, self).__init__(max_workers=14)
...
if __name__ == '__main__':
    ...
    Q, total_rew = q_learning(env_obj, alpha=0.1, gamma=0.01, epsilon=0.1)
    # print "Q is ", Q
    ...
    filename = "/home/vvarier/dvrk_automated_suturing/iros2020/suturing_grid3d_size11_data2/grid11_parallel/policy_grid11.txt"
