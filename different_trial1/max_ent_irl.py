...
class MaxEntIRL:
    ...
    def max_ent_irl(self, trajectories, discount, n_trajectories, epochs, learning_rate):
        ...
        filename = "/home/vignesh/PycharmProjects/motion_planning_max_entropy_irl/different_trial1/grid11_parallel/weights_grid11"
        ...
        for i in range(epochs):
            ...
            expected_svf = self.find_expected_svf(weights, discount, total_states, trajectories, reward)
