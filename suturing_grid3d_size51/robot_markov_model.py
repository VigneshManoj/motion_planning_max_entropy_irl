...
class RobotMarkovModel:
    def __init__(self):
        ...
        #     ("/home/dkoolrajamani/suturing_grid3d_size51/grid50_parallel/max_ent_grid50_data1.csv",
        #      delimiter=",")
        # trajectories2 = np.genfromtxt\
        #     ("/home/dkoolrajamani/suturing_grid3d_size51/grid50_parallel/max_ent_grid50_data2.csv",
        #      delimiter=",")
        # trajectories3 = np.genfromtxt\
        #     ("/home/dkoolrajamani/suturing_grid3d_size51/grid50_parallel/max_ent_grid50_data3.csv",
        #      delimiter=",")
        trajectories1 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/max_ent_trial4_parallel_compute_grid_size/iros2020/suturing_grid3d_size51/grid50_parallel/max_ent_grid50_data1.csv",
             delimiter=",")
        trajectories2 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/max_ent_trial4_parallel_compute_grid_size/iros2020/suturing_grid3d_size51/grid50_parallel/max_ent_grid50_data2.csv",
             delimiter=",")
        trajectories3 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/max_ent_trial4_parallel_compute_grid_size/iros2020/suturing_grid3d_size51/grid50_parallel/max_ent_grid50_data3.csv",
             delimiter=",")
        # trajectories1 = np.genfromtxt\
        #     ("/home/vignesh/Thesis_Suture_data/trial2/suture_data_trial2/730841.csv",
        #      delimiter=",")
        # trajectories2 = np.genfromtxt\
        #     ("/home/vignesh/Thesis_Suture_data/trial2/suture_data_trial2/832953.csv",
        #      delimiter=",")
        # trajectories3 = np.genfromtxt\
        #     ("/home/vignesh/Thesis_Suture_data/trial2/suture_data_trial2/781266.csv",
        #      delimiter=",")
