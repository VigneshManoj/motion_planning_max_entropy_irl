...
class RobotStateUtils(concurrent.futures.ThreadPoolExecutor):
    def __init__(self, grid_size, discount, terminal_state_val_from_trajectory):
        ...
        self.lin_space_limits_x = np.linspace(-0.04, 0.01, self.grid_size, dtype='float32')
        self.lin_space_limits_y = np.linspace(0.020, 0.07, self.grid_size, dtype='float32')
        self.lin_space_limits_z = np.linspace(-0.142, -0.092, self.grid_size, dtype='float32')
