...
def main(grid_size, discount_factor, epochs, learning_rate):
    ...
    irl = MaxEntIRL(n_trajectories, grid_size, n_trajectories)
    # Calculates the reward function based on the Max Entropy IRL algorithm
    reward, weights = irl.max_ent_irl(trajectories, discount_factor, epochs, learning_rate)
...
if __name__ == '__main__':
    ...
    main(grid_size=25, discount_factor=0.9, epochs=100, learning_rate=0.1)
