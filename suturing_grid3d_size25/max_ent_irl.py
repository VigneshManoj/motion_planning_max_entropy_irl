...
class MaxEntIRL:
    ...
    def max_ent_irl(self, trajectories, discount, epochs, learning_rate):
        ...
        filename = "/home/vvarier/dvrk_automated_suturing/iros2020/suturing_grid3d_size25/grid25_parallel/weights_grid25.txt"
    ...
    def get_state_val_index(self, state_val):
        index_val = abs((state_val[0] + 0.036)/0.002 * pow(self.grid_size, 2)) + \
                    abs((state_val[1] - 0.020)/0.002 * pow(self.grid_size, 1)) + \
                    abs((state_val[2] + 0.148)/0.002)
