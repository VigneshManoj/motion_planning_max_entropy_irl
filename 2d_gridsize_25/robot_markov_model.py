...
class RobotMarkovModel:
    def __init__(self):
        ...
        trajectories1 = np.genfromtxt\
            ("/home/vvarier/dvrk_automated_suturing/iros2020/2d_gridsize_25/data/2d_rl.csv", delimiter=",")
        # trajectories1 = np.genfromtxt \
        #     ("/home/vignesh/PycharmProjects/motion_planning_max_entropy_irl/2d_gridsize_25/data/2d_rl.csv", delimiter=",")
        # trajectories2 = np.genfromtxt\
        #     ("/home/vvarier/dvrk_automated_suturing/iros2020/motion_planning_max_entropy_irl/data/check_data_max_ent_trial5_code2.csv", delimiter=",")
        # trajectories3 = np.genfromtxt\
        #     ("/home/vvarier/dvrk_automated_suturing/iros2020/motion_planning_max_entropy_irl/data/check_data_max_ent_trial5_code3.csv", delimiter=",")
