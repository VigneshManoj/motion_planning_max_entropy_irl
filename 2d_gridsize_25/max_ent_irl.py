...
class MaxEntIRL:
    ...
    def max_ent_irl(self, trajectories, discount, epochs, learning_rate):
        ...
        filename = "/home/vvarier/dvrk_automated_suturing/iros2020/2d_gridsize_25/data/weights_grid2d.txt"
        ...
        for i in range(epochs):
            ...
            self.traj_index = random.randint(0, len(trajectories) - 1)
    ...
    def get_state_val_index(self, state_val):
        index_val = abs((state_val[0] + 0.012)/0.002 * pow(self.grid_size, 1)) + \
                    abs((state_val[1])/0.002)
