...
class RobotStateUtils(concurrent.futures.ThreadPoolExecutor):
    def __init__(self, grid_size, discount, terminal_state_val_from_trajectory):
        ...
        self.lin_space_limits_x = np.linspace(-0.012, 0.036, self.grid_size, dtype='float32')
        self.lin_space_limits_z = np.linspace(0.0, 0.048, self.grid_size, dtype='float32')
    ...
    def reward_func(self, state):
        ...
        #     features_arr.append(features[n](end_pos_x, end_pos_y))
    ...
    # def features_array_sec_func(self, end_pos_x, end_pos_y):
