...
if __name__ == '__main__':
    ...
    Q, total_rew = q_learning(env_obj, alpha=0.1, gamma=0.1, epsilon=0.1)
    # print "Q is ", Q
    ...
    filename = "/home/vvarier/dvrk_automated_suturing/iros2020/suturing_grid3d_size11_data3/grid11_parallel/policy_grid11.txt"
